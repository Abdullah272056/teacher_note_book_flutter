...
FilterListDataModelClass filterListDataModelClassFromJson(String str) => FilterListDataModelClass.fromJson(json.decode(str));

String filterListDataModelClassToJson(FilterListDataModelClass data) => json.encode(data.toJson());

class FilterListDataModelClass {
  FilterListDataModelClass({
    this.success,
    this.data,
    this.message,
  });
  ...
  factory FilterListDataModelClass.fromJson(Map<String, dynamic> json) => FilterListDataModelClass(
...
class Data {
  ...
  List<String> ? catArr;
  List<String> ? subCatArr;
  List<String> ? innerCatArr;
  List<String> ? brands;
  String ? brandName;
  String ? min;
  String ? max;
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    subCatArr: List<String>.from(json["sub_cat_arr"].map((x) => x)),
    innerCatArr: List<String>.from(json["inner_cat_arr"].map((x) => x)),
    brands: List<String>.from(json["brands"].map((x) => x)),
    brandName: json["brand_name"].toString(),
    min: json["min"].toString(),
    max: json["max"].toString(),
    sizeId: List<String>.from(json["size_id"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "cat_arr": List<String>.from(catArr!.map((x) => x)),
    "sub_cat_arr": List<String>.from(subCatArr!.map((x) => x)),
    "inner_cat_arr": List<String>.from(innerCatArr!.map((x) => x)),
    "brands": List<String>.from(brands!.map((x) => x)),
    "brand_name": brandName,
    "min": min,
    "max": max,
    "size_id": List<String>.from(sizeId!.map((x) => x)),
...
class Products {
  ...
  Map<String, dynamic> toJson() => {
    ...
    "links": List<String>.from(links!.map((x) => x.toJson())),
...
class InnerCategoryClass {
  ...
  factory InnerCategoryClass.fromJson(Map<String, dynamic> json) => InnerCategoryClass(
    ...
    createdAt:  json["created_at"].toString() ,
    updatedAt:  json["updated_at"].toString() ,
    hideProductFromHome: json["hide_product_from_home"].toString(),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "created_at": createdAt ,
    "updated_at": updatedAt ,
    "hide_product_from_home":  hideProductFromHome,
  };
}
...
class Seller {
  ...
  factory Seller.fromJson(Map<String, dynamic> json) => Seller(
    ...
    aboutSeller: json["about_seller"].toString(),
    createdAt:  json["created_at"].toString() ,
    updatedAt:  json["updated_at"].toString() ,
  );
